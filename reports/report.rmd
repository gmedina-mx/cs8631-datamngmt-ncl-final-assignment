...
knitr::kable(df, col.names = gsub("[.]", " ", names(df)), caption = "Enrollments over all runs")
...
```{r eda20, include = TRUE, message = TRUE, out.width="75%", fig.cap="Total Enrollments per Age Range", fig.align='center'}
...
```{r eda3, include = TRUE, message = TRUE, out.width="75%", fig.cap="Total Enrollments per Highest Education Level", fig.align='center'}
...
```{r eda5, include = TRUE, message = TRUE, out.width="75%", fig.cap="Total Enrollments per Employment Area", fig.align='center'}
...
```{r eda7, include = TRUE, message = TRUE, out.width="75%", fig.cap="Total Leavings per Archetypes", fig.align='center'}
...
```{r eda8, include = TRUE, message = TRUE, out.width="75%", fig.cap="Leaving Reasons for all Runs", fig.align='center'}
